...
class Publish {
    static async distribute() {
        ...
        instance.copyFiles("./baremetal/**/*.*");
        instance.copyFiles("./bootrap/**/*.*");
        instance.copyFiles("./lib/**/*.*");
        instance.copyFiles("./scss/**/*.*");
        instance.copyFiles("./third-party/**/*.*");
        instance.copyFiles("./webcomponents/**/*.*");

        fs.copyFileSync("./batch-worker.js", "./publish/batch-worker.js");
        fs.copyFileSync("./group-worker.js", "./publish/group-worker.js");
        fs.copyFileSync("./favicon.ico", "./publish/favicon.ico");
